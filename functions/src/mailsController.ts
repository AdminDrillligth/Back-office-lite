...
const sendEmailResetPasswordAccount = async (data:any) =>{
    ...
    return new Promise<any>((resolve, reject) => {
      ...
      "img.max-width {  max-width: 100% !important; } .column.of-2 { width: 50%; } .column.of-3 { width: 33.333%;} .column.of-4 {  width: 25%; } ul ul ul ul  { list-style-type: disc !important;}"+
      ...
      "<h5 style='text-align: center; font-family: inherit'><span style='color: #ffffff; font-family: lucida sans unicode,lucida grande,sans-serif'>vous serez alors redirigé vers la page souhaitée.</span></h5><div></div></div></td>"+
      "</tr></tbody></table><table border='0' cellpadding='0' cellspacing='0' align='center' width='100%' role='module' data-type='columns' style='padding:0px 0px 0px 0px;' bgcolor='#101c23' data-distribution='1,1'>"+
      ...
      "<tr><td style='font-size:6px; line-height:10px; padding:34px 0px 0px 0px;' valign='top' align='center'><img class='max-width' border='0' style='display:block; color:#000000; text-decoration:none; font-family:Helvetica, arial, sans-serif; font-size:16px; max-width:54% !important; width:54%; height:auto !important;' width='157' alt='' data-proportionally-constrained='true' data-responsive='true' src='http://cdn.mcauto-images-production.sendgrid.net/56c287cecb58892f/c4511848-d938-41d8-b668-fd63aa91beca/190x526.png'>"+
      "</td></tr></tbody></table></td></tr></tbody></table></td></tr></tbody></table><table class='module' role='module' data-type='divider' border='0' cellpadding='0' cellspacing='0' width='100%' style='table-layout: fixed;' data-muid='faab146d-1fdd-46fd-82be-bbcfaf7a198a'>"+
      ...
      "<td style='padding:18px 0px 18px 0px; line-height:22px; text-align:inherit; background-color:#101c23;' height='100%' valign='top' bgcolor='#101c23' role='module-content'><div><div style='font-family: inherit; text-align: center'><span style='color: #ffffff'>Pour vos questions et suggestions, nous vous invitons à nous contacter sur </span><a href='mailto:contact@drilllight.fr?subject=&amp;body='><span style='color: #0048ba'>contact@drilllight.fr</span></a></div><div style='font-family: inherit; text-align: inherit'><br></div><div></div></div></td></tr></tbody></table></td></tr></table><!--[if mso]></td></tr></table></center><![endif]-->"+
